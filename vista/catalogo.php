	...
	<div class="container">
		...
		<div class="content">
			<div class="main">
				...
				<fieldset class="data">
						<legend><strong>Filtrar Peliculas</strong></legend>

				<form action="../vista/reportepeli.php" method="POST" target="_blank">
					<label for="stockini">Por Stock desde : </label>
					<input type="text" id="stockini" name="stockini" onkeypress="return justNumbers(event);" maxlength="4">
					<label for="stockfin">hasta : </label>
					<input type="text" id="stockfin" name="stockfin" onkeypress="return justNumbers(event);" maxlength="4">

				<div class="divformu">
					<label for="anho">Por Año : </label>
					<input type="text" id="anho" name="anho" maxlength="4">
				</div>

				<div class="divformu">
					<label for="idgenero">Por Genero : </label>
					<?php echo $genero; ?>
				</div>
			
				<div class="divformu">
					<label for="productora">Por Productora : </label>
					<?php echo $productora; ?>
				</div>
				<center>
				<div class="divboton">
					<input align="center" type="submit" class="boton" value="Crear Reporte">
					<a href = "../vista/prereportepeli.php"> <input align="center" type="button" class="boton" value="Regresar"> </a>
				</div>
			</center>
			</form>
			</div>
